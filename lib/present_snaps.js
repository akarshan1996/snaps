...
function presentSnaps(loginResponse, username) {
...
var getMediaType = function(snap) {
  return ['image', 'video', 'videoNoAudio', 'friendRequest', 'friendRequestImage', 'friendRequestVideo', 'friendRequestVideoNoAudio'][snap.m];
};
var getState = function(snap) {
  if (snap.st == -1) {
    return 'none';
  }
  return ['sent', 'delivered', 'viewed', 'screenshot'][snap.st];
};
