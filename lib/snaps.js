...
var send = $traceurRuntime.assertObject(require('./endpoints/ph_send')).send;
var uploadImage = $traceurRuntime.assertObject(require('./endpoints/ph_upload')).uploadImage;
...
($traceurRuntime.createClass)(Snaps, {
  send: function(rawImageData, recipients, snapTime) {
    var $__0 = this;
    ...
    uploadPromise.then((function(mediaId) {
      var timestamp = Date.now();
